...
$(function () {
    let basicp = $('#basicp');
    let regularp = $('#regularp');
    let premiump = $('#premiump');
    let basictext = $('#basictxt');
    let regulartext = $('#regulartext');
    let premiumtext = $('#premiumext');
    ...
    $('.basic').on('click', function () {
        $('.basic').slideUp('slow');
        $(basicp).show(500);
        $(basictext).animate({fontWeight:'bolder',fontSize:'30px'})

    });
    $('.regular').on('click', function () {
        $('.regular').slideUp('slow');
        $(regularp).show(500);
        $(regulartext).animate({fontWeight:'bolder',fontSize:'30px'})
    });
    $('.premium').on('click', function () {
        $('.premium').slideUp('slow');
        $(premiump).show(500);
        $(premiumtext).animate({fontWeight:'bolder',fontSize:'30px'})
    });

    //Hide paragraph content
    $(basicp, basictext).on('click', function () {
        $('.basic').slideDown();
        $(basicp).hide(500);
        $(basictext).animate({fontWeight:'normal',fontSize:'16px'})
    });
    $(regularp, regulartext).on('click', function () {
        $('.regular').slideDown();
        $(regularp).hide(500);
        $(regulartext).animate({fontWeight:'normal',fontSize:'16px'})
    });
    $(premiump, premiumtext).on('click', function () {
        $('.premium').slideDown();
        $(premiump).hide(500);
        $(premiumtext).animate({fontWeight:'normal',fontSize:'16px'})
    });
})
